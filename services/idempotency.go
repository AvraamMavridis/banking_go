...
func (s *IdempotencyService) EnsureUnique(tx *gorm.DB, key string) error {
...
func (s *IdempotencyService) Save(tx *gorm.DB, key string, statusCode int, response any) error {
